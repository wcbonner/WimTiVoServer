...
public:
	...
	const CString GetFFMPEGCommandLine(const CString & csFFMPEGPath = _T("ffmpeg.exe"), const bool bForceSubtitles = false, const CString& TSN = _T(""), const CString& csFormat = _T("")) const;
#ifdef CACHE_FILE
